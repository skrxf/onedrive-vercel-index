...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'zhengxu@microsoft.xfywz.cn',
  ...
  protectedRoutes: ['/XiaoFeng', '/🥟 Some test files/Protected route'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'mailto:2867404078@qq.com',
